...
[];
true ->
enc_HWLoadIndicator(Enc7@element)
end
end,
begin
...
[];
true ->
enc_S1TNLLoadIndicator(Enc9@element)
end
end,
begin
...
[];
true ->
enc_RadioResourceStatus(Enc11@element)
end
end|begin
...
[];
true ->
'enc_CellMeasurementResult-Item_iE-Extensions'(Enc13@element)
end
end].
...
Enc7@output = enc_os_Extension2(Enc6@element, Enc1@element),
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value5(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_ResourceStatusUpdate_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value8(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_ResourceStatusFailure_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value11(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_ResourceStatusResponse_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value14(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
enc_ECGI(Enc3@element)
end|begin
Enc4@element = element(3, Val),
if Enc4@element =:= asn1_NOVALUE ->
[];
true ->
'enc_CellToReport-Item_iE-Extensions'(Enc4@element)
end
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value18(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_ResourceStatusRequest_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value21(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value24(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value27(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
enc_ECGI(Enc4@element)
end,
begin
Enc5@element = element(3, Val),
'enc_ServedCell-Information'(Enc5@element)
end,
begin
Enc6@element = element(4, Val),
...
[];
true ->
'enc_Neighbour-Information'(Enc6@element)
end
end|begin
...
[];
true ->
'enc_ServedCellsToModify-Item_iE-Extensions'(Enc8@element)
end
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value33(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[];
true ->
'enc_UL-InterferenceOverloadIndication'(Enc7@element)
end
end,
begin
Enc9@element = element(4, Val),
...
[];
true ->
'enc_UL-HighInterferenceIndicationInfo'(Enc9@element)
end
end,
begin
Enc11@element = element(5, Val),
...
[];
true ->
enc_RelativeNarrowbandTxPower(Enc11@element)
end
end|begin
Enc13@element = element(6, Val),
if Enc13@element =:= asn1_NOVALUE ->
[];
true ->
'enc_CellInformation-Item_iE-Extensions'(Enc13@element)
end
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value37(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_LoadInformation_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value40(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_X2SetupFailure_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value43(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_X2SetupResponse_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value46(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_X2SetupRequest_protocolIEs(Enc2@element)
end].
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_ResetResponse_protocolIEs(Enc2@element)
end].
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_ResetRequest_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value55(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value61(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_UEContextRelease_protocolIEs(Enc2@element)
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value64(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
begin
Enc9@element = element(4, Val),
enc_COUNTvalue(Enc9@element)
end,
begin
Enc10@element = element(5, Val),
enc_COUNTvalue(Enc10@element)
end|begin
Enc11@element = element(6, Val),
if Enc11@element =:= asn1_NOVALUE ->
[];
true ->
'enc_E-RABs-SubjectToStatusTransfer-Item_iE-Extensions'(Enc11@element)
end
end].
...
[<<0:1>>|begin
Enc2@element = element(2, Val),
enc_SNStatusTransfer_protocolIEs(Enc2@element)
end].
...
[];
true ->
enc_GTPtunnelEndpoint(Enc7@element)
end
end,
begin
Enc9@element = element(4, Val),
...
[];
true ->
enc_GTPtunnelEndpoint(Enc9@element)
end
end|begin
Enc11@element = element(5, Val),
if Enc11@element =:= asn1_NOVALUE ->
[];
true ->
'enc_E-RABs-Admitted-Item_iE-Extensions'(Enc11@element)
end
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value78(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_Value81(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
begin
Enc6@element = element(3, Val),
'enc_E-RAB-Level-QoS-Parameters'(Enc6@element)
end,
begin
Enc7@element = element(4, Val),
if Enc7@element =:= asn1_NOVALUE ->
[];
Enc7@element =:= 'dL-forwardingProposed' ->
<<0:1>>;
true ->
...
begin
Enc10@element = element(5, Val),
enc_GTPtunnelEndpoint(Enc10@element)
end|begin
Enc11@element = element(6, Val),
if Enc11@element =:= asn1_NOVALUE ->
[];
true ->
'enc_E-RABs-ToBeSetup-Item_iE-Extensions'(Enc11@element)
end
end].
...
enc_UESecurityCapabilities(Enc8@element)
end,
begin
Enc9@element = element(4, Val),
'enc_AS-SecurityInformation'(Enc9@element)
end,
begin
Enc10@element = element(5, Val),
enc_UEAggregateMaximumBitRate(Enc10@element)
end,
begin
Enc11@element = element(6, Val),
if Enc11@element =:= asn1_NOVALUE ->
...
'enc_E-RABs-ToBeSetup-List'(Enc14@element)
end,
align,
begin
...
[];
true ->
enc_HandoverRestrictionList(Enc17@element)
end
end,
begin
...
[];
true ->
enc_LocationReportingInformation(Enc19@element)
end
end|begin
...
[];
true ->
'enc_UE-ContextInformation_iE-Extensions'(Enc21@element)
end
end].
...
true ->
[<<1:1>>,
align|encode_fragmented(Enc4@element, 1)]
end
end|begin
Enc6@element = element(4, Val),
if Enc6@element =:= asn1_NOVALUE ->
[];
true ->
'enc_UL-HighInterferenceIndicationInfo-Item_iE-Extensions'(Enc6@element)
end
end].
...
Enc5@element = element(3, Val),
Enc7@element = element(4, Val),
if Enc5@element =:= normal ->
if Enc7@element =:= normal ->
<<0:1,0:1,0:1,0:1>>;
Enc7@element =:= extended ->
<<0:1,0:1,0:1,1:1>>;
true ->
exit({error,{asn1,{illegal_value,Enc7@element}}})
end;
Enc5@element =:= extended ->
if Enc7@element =:= normal ->
<<0:1,1:1,0:1,0:1>>;
Enc7@element =:= extended ->
<<0:1,1:1,0:1,1:1>>;
...
[];
true ->
'enc_SpecialSubframe-Info_iE-Extensions'(Enc9@element)
end
end].
...
begin
Enc8@element = element(5, Val),
'enc_BroadcastPLMNs-Item'(Enc8@element)
end,
begin
Enc9@element = element(6, Val),
'enc_EUTRA-Mode-Info'(Enc9@element)
end|begin
Enc10@element = element(7, Val),
if Enc10@element =:= asn1_NOVALUE ->
[];
true ->
'enc_ServedCell-Information_iE-Extensions'(Enc10@element)
end
end].
...
begin
Enc4@element = element(2, Val),
'enc_ServedCell-Information'(Enc4@element)
end,
begin
Enc5@element = element(3, Val),
...
[];
true ->
'enc_Neighbour-Information'(Enc5@element)
end
end|begin
Enc7@element = element(4, Val),
if Enc7@element =:= asn1_NOVALUE ->
[];
true ->
'enc_ServedCells_SEQOF_iE-Extensions'(Enc7@element)
end
end].
...
begin
Enc3@element = element(2, Val),
if Enc3@element =:= lowLoad ->
<<0:1,0:2>>;
Enc3@element =:= mediumLoad ->
<<0:1,1:2>>;
Enc3@element =:= highLoad ->
<<0:1,2:2>>;
Enc3@element =:= overLoad ->
<<0:1,3:2>>;
true ->
exit({error,{asn1,{illegal_value,Enc3@element}}})
end
...
begin
Enc5@element = element(3, Val),
if Enc5@element =:= lowLoad ->
<<0:1,0:2>>;
Enc5@element =:= mediumLoad ->
<<0:1,1:2>>;
Enc5@element =:= highLoad ->
<<0:1,2:2>>;
Enc5@element =:= overLoad ->
<<0:1,3:2>>;
true ->
exit({error,{asn1,{illegal_value,Enc5@element}}})
end
...
[];
true ->
'enc_S1TNLLoadIndicator_iE-Extensions'(Enc7@element)
end
end].
...
begin
Enc3@element = element(2, Val),
if 0 =< Enc3@element, Enc3@element < 101 ->
<<Enc3@element:7>>;
true ->
exit({error,{asn1,{illegal_value,Enc3@element}}})
end
...
begin
Enc5@element = element(3, Val),
if 0 =< Enc5@element, Enc5@element < 101 ->
<<Enc5@element:7>>;
true ->
exit({error,{asn1,{illegal_value,Enc5@element}}})
end
...
begin
Enc7@element = element(4, Val),
if 0 =< Enc7@element, Enc7@element < 101 ->
<<Enc7@element:7>>;
true ->
exit({error,{asn1,{illegal_value,Enc7@element}}})
end
...
begin
Enc9@element = element(5, Val),
if 0 =< Enc9@element, Enc9@element < 101 ->
<<Enc9@element:7>>;
true ->
...
begin
Enc11@element = element(6, Val),
if 0 =< Enc11@element, Enc11@element < 101 ->
<<Enc11@element:7>>;
true ->
exit({error,{asn1,{illegal_value,Enc11@element}}})
end
...
if 0 =< Enc13@element, Enc13@element < 101 ->
<<Enc13@element:7>>;
true ->
...
[];
true ->
'enc_RadioResourceStatus_iE-Extensions'(Enc15@element)
end
end].
...
begin
Enc5@element = element(3, Val),
if Enc5@element =:= minusInfinity ->
<<0:1,0:4>>;
Enc5@element =:= minusEleven ->
<<0:1,1:4>>;
Enc5@element =:= minusTen ->
<<0:1,2:4>>;
Enc5@element =:= minusNine ->
<<0:1,3:4>>;
Enc5@element =:= minusEight ->
<<0:1,4:4>>;
Enc5@element =:= minusSeven ->
<<0:1,5:4>>;
Enc5@element =:= minusSix ->
<<0:1,6:4>>;
Enc5@element =:= minusFive ->
<<0:1,7:4>>;
Enc5@element =:= minusFour ->
<<0:1,8:4>>;
Enc5@element =:= minusThree ->
<<0:1,9:4>>;
Enc5@element =:= minusTwo ->
<<0:1,10:4>>;
Enc5@element =:= minusOne ->
<<0:1,11:4>>;
Enc5@element =:= zero ->
<<0:1,12:4>>;
Enc5@element =:= one ->
...
begin
Enc11@element = element(6, Val),
if 0 =< Enc11@element, Enc11@element < 5 ->
<<0:1,Enc11@element:3>>;
true ->
[<<1:1>>,
align|encode_unconstrained_number(Enc11@element)]
end
end|begin
Enc13@element = element(7, Val),
if Enc13@element =:= asn1_NOVALUE ->
[];
true ->
'enc_RelativeNarrowbandTxPower_iE-Extensions'(Enc13@element)
end
end].
...
begin
Enc4@element = element(3, Val),
if 0 =< Enc4@element, Enc4@element < 504 ->
[<<0:1>>,
...
[];
true ->
'enc_Neighbour-Information_SEQOF_iE-Extensions'(Enc8@element)
end
end].
...
Enc5@element = element(3, Val),
if Enc1@element =:= asn1_NOVALUE ->
if Enc3@element =:= 'change-of-serving-cell' ->
...
[];
true ->
'enc_LocationReportingInformation_iE-Extensions'(Enc7@element)
end
end].
...
[];
true ->
'enc_HWLoadIndicator_iE-Extensions'(Enc7@element)
end
end].
...
[];
true ->
'enc_GUMMEI_iE-Extensions'(Enc6@element)
end
end].
...
[];
true ->
'enc_GU-Group-ID_iE-Extensions'(Enc7@element)
end
end].
...
[];
true ->
'enc_GTPtunnelEndpoint_iE-Extensions'(Enc7@element)
end
end].
...
[];
true ->
'enc_GlobalENB-ID_iE-Extensions'(Enc6@element)
end
end].
...
[];
true ->
'enc_E-RAB-Item_iE-Extensions'(Enc6@element)
end
end].
...
[];
true ->
'enc_E-RAB-Level-QoS-Parameters_iE-Extensions'(Enc9@element)
end
end].
...
[];
true ->
'enc_ECGI_iE-Extensions'(Enc7@element)
end
end].
...
begin
Enc9@element = element(5, Val),
'enc_SpecialSubframe-Info'(Enc9@element)
end|begin
Enc10@element = element(6, Val),
if Enc10@element =:= asn1_NOVALUE ->
[];
true ->
'enc_TDD-Info_iE-Extensions'(Enc10@element)
end
end].
...
[];
true ->
'enc_FDD-Info_iE-Extensions'(Enc11@element)
end
end].
...
[];
true ->
'enc_CriticalityDiagnostics-IE-List_SEQOF_iE-Extensions'(Enc9@element)
end
end].
...
<<1:2>>;
Enc10@element =:= 'unsuccessful-outcome' ->
<<2:2>>;
true ->
...
[];
true ->
'enc_AS-SecurityInformation_iE-Extensions'(Enc7@element)
end
end].
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_UnsuccessfulOutcome141(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_SuccessfulOutcome143(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
...
Enc6@element = element(4, Val),
Enc7@output = enc_os_InitiatingMessage145(Enc6@element, Enc1@element),
Enc7@bin = complete(Enc7@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[Enc7@len|Enc7@bin];
